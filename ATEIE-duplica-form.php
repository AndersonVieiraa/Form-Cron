...
<!-- Diálogo editar ATEIE -->
		<form id="fm5" method="post" novalidate>
			<div class="easyui-panel" style="width:100%;padding:10px 10px;border:0px solid #96C2F4;">
					...
					<b><font size="3" color="white">Criando ATEIE a partir de um MODELO</font></b>
					</td></tr></table><br>
		...
		<div align="right" style="width:100%; height:100px; padding:10px; padding-bottom:50px; padding-right:100px; background: #eee; border-top:1px #ccc solid; margin-bottom:-10px;" id="dlg5-buttons">
			<a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="savenovaATEIE()" style="width:190px;padding:3px;">Criar</a>
		...
		function savenovaATEIE(){
			$('#fm5').form('submit',{
				url: 'EDT/duplicar-ATEIE.php',
				onSubmit: function(){
