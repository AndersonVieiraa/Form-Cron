...
<table border="0" style="border-collapse:collapse; width:100%;height:100%; table-layout:; align: center; ">
		<tr>
		<td  colspan="2" align="right" valign="top" class="tabletopo_colunamenu" style="padding:10px;">
		...
		<tr>
			<td   width="30%" height="12%" style="padding:15px">				
				<a href="index-adm.php"> <img src="http:ilustracoes/logo02.png" class="logo" /></a>
			</td>
...
if (!empty($_POST) AND (empty($_POST['numero']))) {
     ...
     header("Location: search-edt.php?a=1"); exit;
...
//verifica se tem numero sendo pesquisado antes de login
if (empty($_GET['num'])) {
...
//FIM verifica se tem numero sendo pesquisado antes de login
?>
			...
			<div class="easyui-panel" style="width:100%;padding:10px 10px; border:0px solid #96C2F4; padding-bottom:40px;">	
				...
				<table align="center" style="width:90%; border-spacing:10px;  border-radius:4px; border:0px solid #96C2F4; background:#6BA6DB;">
					...
					<tr style="background:#CDCDCD;">
							...
							<td align="center" style="padding:10px;">EDITAR</td>
							<td align="center" style="padding:10px;">DUPLICAR</td>
						...
						<?php
							...
							$sequencia1 = 1;
									...
									echo '</td>';		
									echo '<td align="center" style="padding:10px;">';
									echo '<a href="MO-edita-form.php?id_mo='; echo $item1['id_mo'];
									echo ' "><div class="botao_edt">Editar</div></a>';		
									echo '</td>';
									echo '<td align="center" style="padding:10px;">';
									echo '<a href="MO-duplica-form.php?id_mo='; echo $item1['id_mo'];
									echo ' "><div class="botao_edt">Duplicar</div></a>';
									echo '</td>';
									echo '<td align="center" style="padding:10px;">';
					...
					<tr style="background:#CDCDCD;">
						...
						<?php
							...
							$sequencia2 = 1; 
									...
									echo '</td>';
									echo '<td align="center" style="padding:10px;">';
									echo '<a href="AI-edita-form.php?id_ai='; echo $item2['id_ai'];
									echo ' "><div class="botao_edt">Editar</div></a>';		
									echo '</td>';
									echo '<td align="center" style="padding:10px;">';
									echo '<a href="AI-duplica-form.php?id_ai='; echo $item2['id_ai'];
									echo ' "><div class="botao_edt">Duplicar</div></a>';		
									echo '</td>';
									echo '<td align="center" style="padding:10px;">';
					...
					<tr style="background:#CDCDCD;">
						...
						<?php
							...
							$sequencia3 = 1;
									...
									echo '</td>';		
									echo '<td align="center" style="padding:10px;">';
									echo '<a href="ATEIE-edita-form.php?id_ateie='; echo $item3['id_ateie'];
									echo ' "><div class="botao_edt">Editar</div></a>';		
									echo '</td>';
									echo '<td align="center" style="padding:10px;">';
									echo '<a href="ATEIE-duplica-form.php?id_ateie='; echo $item3['id_ateie'];
									echo ' "><div class="botao_edt">Duplicar</div></a>';
									echo '</td>';
									echo '<td align="center" style="padding:10px;">';
				...
				<table align="center" style="width:90%; margin-top:80px;  border-spacing:10px;  border-radius:4px; border:0px solid #96C2F4; background:#6BA6DB;">
					...
					<table border="1" align="center" style="border-collapse:collapse; width:90%; border-spacing:0px; margin-top:10px; padding: 0PX; border-radius:4px; border:0px solid #DCDCDC; padding-top:5px;">
						...
						if (empty($_POST['numero']) AND empty($_GET['num'])) {
						}
