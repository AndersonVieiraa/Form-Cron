...
<title>Lista de Transmissão PED 230kV</title>
...
<div class="box" align="center">
    ...
    <div class="easyui-panel" title="Lista de Transmissão PED 230kV" style="width: 100%; height: 100%; padding:5px; ">
        <div>
           <?php
				include 'conn.php';
					
					
				$where = "ses like '%PED%' and ses like '%04%' " ;
				$sql = mysql_query("Select * From acessantes where " . $where . " Order By empresa ASC");
				$sql2 = mysql_query("Select * From acessantes where " . $where . " Order By empresa ASC");
				$sql3 = mysql_query("Select * From acessantes where " . $where . " Order By empresa ASC");
				$sql4 = mysql_query("Select * From acessantes where " . $where . " Order By empresa ASC");
				$sql5 = mysql_query("Select * From acessantes where " . $where . " Order By empresa ASC");
				$sql6 = mysql_query("Select * From acessantes where " . $where . " Order By empresa ASC");
				$sql7 = mysql_query("Select * From acessantes where " . $where . " Order By empresa ASC");
			...
			<td style="width: 20%; text-align:center; padding:10px; background-color: #CACACA;"><b>Nomes (Pré-Operação)</b></td>
...
?>			
			...
			<tr>
			<td style="width: 20%; text-align:center; padding:10px; background-color: #CACACA;"><b>Empresa</b></td>
			<td style="width: 20%; text-align:center; padding:10px; background-color: #CACACA;"><b>Nomes (Tempo Real)</b></td>
			...
			echo '<td style="width: 40%;text-align:center;padding:5px;">';
			...
			echo '<td style="width: 20%;text-align:center;padding:5px;">';
			while($exibe7 = mysql_fetch_assoc($sql7)){ 
			echo nl2br($exibe7['emailstr']);
			echo '<br>';
			}
			echo '</td>';
