...
$id = intval($_REQUEST['id_ateie']);
$rs = mysql_query("select * from ATEIE where id_ateie='$id'");
$item = mysql_fetch_array($rs); 
 ?>	

<!-- Inicio MENU-->
<div style="position:relative; z-index:2;">
	<table border="0" style="border-collapse:collapse; width:100%;height:100%; table-layout:; align: center; background: url(ilustracoes/fundo3.png)no-repeat right bottom fixed; ">
		<tr>
...
<!-- Diálogo editar ATEIE -->
		<form id="fm7" method="post" novalidate>
			<div class="easyui-panel" align="center" style="width:100%;padding:10px 10px; border:0px solid #96C2F4;">	
			
					<table align="center" style="width:90%; border-spacing:10px;  border-radius:4px; border:0px solid #96C2F4; background:#6BA6DB;">
					<tr><td style="text-align:center;">
					<b><font size="3" color="white">EDITAR ATEIE</font></b>
					</td></tr></table><br>

					<table align="center" border="0" style="width:90%; border-spacing:4px;  border-radius:4px; border:0px solid #96C2F4;">
					
						<tr ><td colspan="2">
							<table style="width:100%; border-spacing:5px;  border-radius:5px; border:1px solid #96C2F4; background:rgba(250,250,250);">
								<tr>
								<td style="padding:10px;">
								Editando: <font color='red'>ATEIE Nº <?php echo $item['numero']; echo "/"; echo $item['ano'];?> </font>
								</td>
								</tr>
							</table>	
						</td><td>
								<table border="0" style="width:100%; border-spacing:5px;  border-radius:5px; border:1px solid #96C2F4; background:rgba(250,250,250);">
									<tr>
					...
					<table border="0" align="center" style="width:89%; border-spacing:7px; border-radius:7px; border:1px solid #96C2F4; padding:5px; margin:10px;">	
						...
						<td>
							<div style="margin-bottom:10px">
								...
								<tr>
								<td>Equipamento sob Intervenção:</td> 
		...
		<div align="right" style="width:100%; height:100px; padding:10px; padding-bottom:50px; padding-right:100px; background: #eee; border-top:1px #ccc solid; margin-bottom:-10px;" id="dlg5-buttons">
			<a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="saveeditATEIE()" style="width:190px;padding:3px;">Salvar Alteração</a>
			<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="window.location.href='ATEIE-edt.php?name=<?php echo $name;?>'" style="width:120px;padding:3px;">Cancelar</a>
		</div>

		<script>


		function saveeditATEIE(){
			$('#fm7').form('submit',{
				url: 'EDT/altera-ATEIE.php?name=<?php echo $name;?>&id_ateie='+<?php echo $item['id_ateie'];?> ,
				onSubmit: function(){
				...
				success: function(result){
						...
						setTimeout(function(){
							...
							window.location.href='ATEIE-edt.php?name=<?php echo $name;?>';
						},1500);
