...
<table border="0" style="width:100%;height:100%; table-layout:; align: center; background: url(ilustracoes/fundo3.png)no-repeat right bottom fixed; ">
		<tr>
			...
			<font size="3" color='grey'>|</font><a class="transp2" href="usuarios.php?name=<?php echo $name;?>" ><font size="3" class="efeitomenu"> &nbsp  Usuários &nbsp</font></a>
				...
				<table border="0" style="width:100%;height:100%; table-layout:fixed; align: center; padding:50px; padding-left:80px; padding-top:00px;">
					...
					<td valign="top" style="">
						<table>
							<tr>
							<td>
								<a class="transp2" href="MO-edit.php?name=<?php echo $name;?>" target="">
					...
					<td valign="top" style="">
						<table>
							<tr>
							<td>
								<a class="transp2" href="AI-edt.php?name=<?php echo $name;?>" target="">
					...
					<td valign="top" style="">
						<table>
							<tr>
							<td>
								<a class="transp2" href="ATEIE-edt.php?name=<?php echo $name;?>" target="">
					...
					<td valign="top" style="">
						<table>
							<tr>
							<td>
								<a class="transp2"  href="graph/index-edt.php?name=<?php echo $name;?>" target="">
					...
					<td valign="top" style="">
						<table>
							<tr>
							<td>
								<a class="transp2" href="Recebidos-edt.php?name=<?php echo $name;?>" target="">	
					...
					<td valign="top" style="">
						<table>
							<tr>
							<td>
								<a class="transp2" href="anexos-edt.php?name=<?php echo $name;?>" target="">
