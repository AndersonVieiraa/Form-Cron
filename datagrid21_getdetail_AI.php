...
$rs = mysql_query("select * from AI where id_ai='$itemid'");
...
<table style="width:70%; padding:10px; border-collapse:collapse; border-radius:0px;border:0px solid #000000;margin-top:30px;" >
		<tr border=1>
		 ...
		 <td style=" border-radius:0px; font:Helvetica; font-size:13px; border:1px solid #000000;" width="65%"><h3 style="text-align: center;">AI - Autorização para Impedimento de Equipamento de Interligação</h3></td> 
		 <td style="padding:5px; width:15%; border-radius:0px;border:1px solid #000000; text-align: center;"><b>AI Número<br></b><font color='#1139B1'><?php echo nl2br($item['numero']); echo "/"; echo nl2br($item['ano']);?>
...
<table style="width:70%; border-collapse:collapse; border-style: hidden; padding:5px; border-radius:0px;border:1px solid #000000; margin-top:5px;"><tr><td>
	...
	<table style="border-collapse:collapse; border-style: hidden; border-spacing:0px; width:100%;font-size:13px">
		<tr align='center'>
			...
			<table><tr>
			<td style="border:0px solid #000000;"><b>Classificação do Impedimento:  &nbsp;</b></td>
		...
		<tr>
		<td colspan="3" style="padding:10px; border-radius:0px; border:1px solid #000000; width:50%"><b>Equipamento a impedir: </b><font color='#1139B1'><?php echo nl2br($item['equipamento']);?></font></td>
		</tr>
		<tr>
		...
		<td colspan="3" rowspan="1" style="padding:5px; border-radius:0px; border:1px solid #000000; width:100%">
				<table>
					<tr>
						<td style="padding:5px; border:0px solid #000000;"><b>Condições do impedimento:</b></td>
						</tr>
						<tr>
						
							<style type="text/css">.condicoes ul{margin-top:1px;} .condicoes p{margin:7px;}</style>
							<td class="condicoes" style="padding:5px; border:0px solid #000000;">
								<font color='#1139B1'><?php echo $item['condicoes'];?></font>
							</td>
					</tr>
				</table>	
		</td>		
	...
	<table border="0" align="center" style="padding:5px; border-collapse:collapse; border-spacing:0px; border-radius:0px; border:0px solid #000000; width:97%;font-size:13px; margin-top:5px;">
		...
		<tr bgcolor="#EFEFEF">
		<td align="center" style="padding:10px; border-radius:0px; border:1px solid #505050; width:33%"><b>Nome</b></td>
		...
		<td align="center" style="padding:10px; border-radius:0px; border:1px solid #505050; width:4%"><font color='#1139B1'><?php echo nl2br($item['hora']);?></font></td>
			...
			<td>
				...
				<tr bgcolor="#EFEFEF">
				<td rowspan="3" align="center" style="padding:10px; border-radius:0px; border:1px solid #505050; width:12%"><b>NÚMERO DO AI</b></td>
