<?php	
	...
	$html .= "<td colspan='3' rowspan='1' style='width:100%; padding-bottom:-2px;'>"; 
			...
			$html .= '<td>';
				...
				$html .= '<tr bgcolor="#EFEFEF">';
				$html .= '<td rowspan="3" align="center" style="padding:2px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:12.2%"><b>Número <br>ATEIE</b></td>';
				$html .= '<td rowspan="1" colspan="4" align="center" style="padding:5px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:41.4%"><b>PREVISTO</b></td>';
				...
				$html .= '<tr bgcolor="#EFEFEF">';
				$html .= '<td colspan="2" align="center" style="padding:3px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:20%"><b>Início</b></td>';		
				$html .= '<td colspan="2" align="center" style="padding:3px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:20%"><b>Término</b></td>';
				...
				$html .= '<td align="center" style="padding:4px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:9.5%"><b>Hora</b></td>';
				$html .= '<td align="center" style="padding:4px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:12%"><b>Data</b></td>';
				$html .= '<td align="center" style="padding:4px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:9.5%"><b>Hora</b></td>';
			...
			$html .= '</table>';		
				...
				if ($a == $row_transacoes['periodicidade']){
						...
						while($i <= $dias ){
							...
							$html .= '<table  style="padding-left:5px; padding-right:0px; border-collapse: collapse; border-spacing:0px; width:99%;">';
							$html .= "<tr>";
							$html .= "<td align='center' style='padding:3px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:10%; color:#1139B1;'>" .$row_transacoes['numero']. "." .$num_diaria. "/" .$row_transacoes['ano']. "</td>";
							$html .= "<td align='center' style='padding:3px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:9.85%; color:#1139B1;'>" .$dia2. "</td>";
							$html .= "<td align='center' style='padding:3px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:8.53%; color:#1139B1;'>" .$row_transacoes['horainicio']."</td>";
							$html .= "<td align='center' style='padding:3px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:9.8%; color:#1139B1;'>" .$dia2."</td>";
							$html .= "<td align='center' style='padding:3px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:8.49%; color:#1139B1;'>" .$row_transacoes['horafim']."</td>";
						...
						$html .= "<td align='center' style='padding:5px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:9.85%; color:#1139B1;'>" .$row_transacoes['datainicio']. "</td>";
						$html .= "<td align='center' style='padding:5px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:8.5%; color:#1139B1;'>" .$row_transacoes['horainicio']."</td>";
						$html .= "<td align='center' style='padding:5px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:9.80%; color:#1139B1;'>" .$row_transacoes['datafim']."</td>";
						$html .= "<td align='center' style='padding:5px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:8.5%; color:#1139B1;'>" .$row_transacoes['horafim']."</td>";
	...
	<tr border="1">
		 <td style=" padding:10px; border-radius:0px;border:1px solid #000000;" width=15% align="center" valign="center"><img style="width:110px;" src="../../img/logoMarcaChesf2.png"></td> 
	...
	<td style="width:70%; text-align:right;"> https://form-cron.000webhostapp.com/Form/EDT/gerarpdf/index_ATEIE.php?id_ateie='.$row_transacoes['id_ateie'].' </td>
