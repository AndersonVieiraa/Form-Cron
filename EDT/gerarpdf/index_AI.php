<?php	
	...
	$id = htmlspecialchars($_REQUEST['id_ai']);
	$result_transacoes = "SELECT * FROM AI where id_ai='$id'";
	...
	$html = '<table style="width:100%;padding:0px;border-collapse:collapse; border-spacing:0px;  border-radius:0px;border:1px solid #000000;">';	
	$html .= '<tbody>';
		...
		$html .= "<table style='border-spacing:0px; border-collapse:collapse; border-style: hidden; width:100%;font-size:13px'>";
			...
			$html .= "<td colspan='3' style='padding:5px; font:Helvetica; font-size:13px; border-radius:0px; border:0px solid #000000; width:100%'>";
				$html .= "<table align='center' border='0'><tr><td><b>Classificação do Impedimento: &nbsp;</b></td>";
					...
					$html .= "<td align='center' style='border:1px solid #000000;width:20px;'><font color='#1139B1'>".$z."</font></td><td><b>Emergência</b></td></tr>";
				$html .= "</table>";
			$html .= "</td>";
			$html .= "</tr>";

			$html .= '<tr>';
			$html .= '<td colspan="3" style="padding:10px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #000000; width:100%"><b>Equipamento a impedir: </b> <font color="#1139B1">'.$row_transacoes['equipamento'].'</td>';
			$html .= '</tr>';
			...
			$html .= '<td colspan="3" rowspan="1" style="padding:5px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #000000; width:100%">';
					$html .= '<table>';
					$html .= '<tr>';
					$html .= '<td style="padding-top:0px; padding-left:5px; padding-left:5px; "><b>Condições do impedimento: </b></td>';
					$html .= '</tr>';
					$html .= '<tr>';
	...
	$html .= "<td colspan='3' rowspan='1' style='width:100%;padding-bottom:-2px;'>"; 
			...
			$html .= '<td>';
				...
				$html .= '<tr bgcolor="#EFEFEF">';
				$html .= '<td rowspan="3" align="center" style="padding:2px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:12.2%"><b>Número <br>AI</b></td>';
			...
			$html .= '</table>';				
				...
				if ($a == $row_transacoes['periodicidade']){
						...
						while($i <= $dias ){
							...
							$html .= '<table  style="padding-left:5px; padding-right:0px; border-collapse: collapse; border-spacing:0px; width:99.2%;">';
							$html .= "<tr>";
							$html .= "<td align='center' style='padding:4px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:9.93%; color:#1139B1;'>" .$row_transacoes['numero']. "." .$num_diaria. "/" .$row_transacoes['ano']. "</td>";
							$html .= "<td align='center' style='padding:4px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:9.8%; color:#1139B1;'>" .$dia2. "</td>";
							$html .= "<td align='center' style='padding:4px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:8.9%; color:#1139B1;'>" .$row_transacoes['horainicio']."</td>";
							$html .= "<td align='center' style='padding:4px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:9.8%; color:#1139B1;'>" .$dia2."</td>";
							$html .= "<td align='center' style='padding:4px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:8.9%; color:#1139B1;'>" .$row_transacoes['horafim']."</td>";
							$html .= "<td align='center' style='padding:4px; border-radius:0px; border:1px solid #505050; width:6.5%; color:#000000;'></td>";
					...
					$html .= "<tr>";
					$html .= "<td colspan='3' rowspan='1' style='width:100%'>"; 
						$html .= '<table  style="padding-left:5px; padding-right:0px; border-collapse: collapse; border-spacing:0px; width:99.22%;">';
							
						$html .= "<tr>";
						$html .= "<td align='center' style='padding:5px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:9.95%; color:#1139B1;'>" .$row_transacoes['numero']. "/" .$row_transacoes['ano']. "</td>";
						$html .= "<td align='center' style='padding:5px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:9.8%; color:#1139B1;'>" .$row_transacoes['datainicio']. "</td>";
						$html .= "<td align='center' style='padding:5px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:8.95%; color:#1139B1;'>" .$row_transacoes['horainicio']."</td>";
						$html .= "<td align='center' style='padding:5px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:9.8%; color:#1139B1;'>" .$row_transacoes['datafim']."</td>";
						$html .= "<td align='center' style='padding:5px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:8.95%; color:#1139B1;'>" .$row_transacoes['horafim']."</td>";
						$html .= "<td align='center' style='padding:5px; border-radius:0px; border:1px solid #505050; width:6.55%; color:#000000;'></td>";
						$html .= "<td align='center' style='padding:5px; border-radius:0px; border:1px solid #505050; width:4.69%; color:#000000;'></td>";
						...
						$html .= "<td align='center' style='padding:5px; border-radius:0px; border:1px solid #505050; width:5.3%; color:#000000;'></td>";
						$html .= "<td align='center' style='padding:5px; border-radius:0px; border:1px solid #505050; width:5.35%; color:#000000;'></td>";
						$html .= "</tr>";
						$html .= '</table>';
						$html .= "</td>";
						$html .= "</tr>";					
	...
	<tr border="1">
		 ...
		 <td style=" border-radius:0px; font:Helvetica; font-size:12px; border:1px solid #000000;" width=65%><h3 style="text-align: center;">AI - Autorização para Impedimento de equipamento de Interligação</h3></td> 
		 <td style="padding:5px; font:Helvetica; font-size:13px; width:20%; border-radius:0px;border:1px solid #000000; text-align: center;"><b>AI Número</b><div style="color:#1139B1;"> '.$row_transacoes['numero'].'/'.$row_transacoes['ano'].' <br><i> '.$row_transacoes['revisaoSaida'].'</i></td>
	</tr>
	</table>
	...
	<td style="width:70%; text-align:right;"> https://form-cron.000webhostapp.com/Form/EDT/gerarpdf/index_AI.php?id_ai='.$row_transacoes['id_ai'].' </td>
	...
	//Exibir a página
	$dompdf->stream( 
		'AI-DONFS-'.$row_transacoes['numero'].'-'.$row_transacoes['ano'].''.$traco.''.$row_transacoes['revisaoSaida'],  
		array(
