<?php	
	...
	$html .= "<td colspan='3' rowspan='1' style='width:100%;padding-bottom:-2px;'>"; 
			...
			$html .= '<td>';
				...
				$html .= '<tr bgcolor="#EFEFEF">';
				$html .= '<td rowspan="3" align="center" style="padding:2px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:10%"><b>Número <br>AI</b></td>';
			...
			$html .= '</table>';				
				...
				if ($a == $row_transacoes['periodicidade']){
						...
						while($i <= $dias ){
							...
							$html .= "<tr>";
							$html .= "<td align='center' style='padding:4px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:8.2%; color:#1139B1;'>" .$row_transacoes['numero']. "/" .$row_transacoes['ano']. "</td>";
							$html .= "<td align='center' style='padding:4px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:9.9%; color:#1139B1;'>" .$dia2. "</td>";
							$html .= "<td align='center' style='padding:4px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:9.1%; color:#1139B1;'>" .$row_transacoes['horainicio']."</td>";
							$html .= "<td align='center' style='padding:4px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:9.9%; color:#1139B1;'>" .$dia2."</td>";
							$html .= "<td align='center' style='padding:4px;font:Helvetica;font-size:12px; border-radius:0px; border:1px solid #505050; width:9.03%; color:#1139B1;'>" .$row_transacoes['horafim']."</td>";
	...
	<td style="width:70%; text-align:right;"> http://10.128.151.18/cron/PHP/Form/EDT/gerarpdf/index_AI.php?id_ai='.$row_transacoes['id_ai'].' </td>
