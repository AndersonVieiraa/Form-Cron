...
<title>Lista de Transmissão IBD 230kV</title>
...
<div class="box" align="center">
    ...
    <div class="easyui-panel" title="Lista de Transmissão IBD 230kV" style="width: 100%; height: 100%; padding:5px; ">
        <div>
           <?php
				include 'conn.php';
					
					
				$where = "ses like '%IBD%' and ses like '%04%' " ;
