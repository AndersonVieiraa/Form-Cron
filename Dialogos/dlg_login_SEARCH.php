<!--Diálogo de Login-->
<div id="dlg23" class="easyui-dialog" title="Dados de login" data-options="iconCls:'icon-lock'" style="width:480px;height:440px;padding:20px;" closed="true">
...
var url;
	function login_search(){
			$('#dlg23').dialog('open').dialog('setTitle','&nbsp Dados de Login');
	}
</script>
