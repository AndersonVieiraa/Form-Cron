<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://10.128.151.18/cron/PHP/Form/xhtml1-transitional.dtd">
...
<!-- Diálogo editar AI -->
		<form id="fm7" method="post" novalidate>
			<div class="easyui-panel" align="center" style="width:100%;padding:10px 10px; border:0px solid #96C2F4;">		
				...
				<table align="center" style="width:90%; border-spacing:10px;  border-radius:4px; border:1px solid #96C2F4; background:#6BA6DB;">
					<tr>
						<td style="text-align:center;"><b><font size="3" color="white">EDITAR AI</font></b>
						</td>
					</tr>
				</table>
